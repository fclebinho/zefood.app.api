...
let OrdersController = class OrdersController {
    ...
    async findAll(userId, page, limit) {
        return this.ordersService.findByCustomer(userId, page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 10);
    }
    async findOne(id, userId) {
        return this.ordersService.findById(id, userId);
    }
    async updateStatus(id, userId, role, updateStatusDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, update_order_status_dto_1.UpdateOrderStatusDto]),
    __metadata("design:returntype", Promise)
