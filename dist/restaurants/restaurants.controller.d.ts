...
export declare class RestaurantsController {
    ...
    findAll(categoryId?: string, search?: string, latitude?: string, longitude?: string, page?: string, limit?: string): Promise<{
        data: ({
            categories: ({
                category: {
                    name: string;
    ...
    updateSettings(userId: string, updateSettingsDto: UpdateRestaurantSettingsDto): Promise<{
        hours: {
            id: string;
            dayOfWeek: number;
            openTime: Date | null;
    ...
    getMyOrders(userId: string, status?: string, page?: string, limit?: string): Promise<{
        customer: {
            fullName: string;
            phone: string | null;
        };
    ...
    getMyMenuCategories(userId: string): Promise<({
        items: {
            name: string;
            id: string;
            createdAt: Date;
    ...
    createMenuCategory(userId: string, createDto: CreateMenuCategoryDto): Promise<{
        name: string;
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateMenuCategory(userId: string, categoryId: string, updateDto: UpdateMenuCategoryDto): Promise<{
        name: string;
        id: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    getMyMenuItems(userId: string, categoryId?: string): Promise<({
        category: {
            name: string;
            id: string;
        };
    ...
    createMenuItem(userId: string, createDto: CreateMenuItemDto): Promise<{
        category: {
            name: string;
            id: string;
        };
    ...
    updateMenuItem(userId: string, itemId: string, updateDto: UpdateMenuItemDto): Promise<{
        category: {
            name: string;
            id: string;
        };
