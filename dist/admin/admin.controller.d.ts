...
export declare class AdminController {
    ...
    getRestaurants(page?: string, limit?: string, status?: string, search?: string): Promise<{
        data: {
            owner: {
                id: string;
                email: string;
    ...
    getOrders(page?: string, limit?: string, status?: string, search?: string): Promise<{
        data: {
            customer: {
                id: string;
                name: string;
    ...
    getDrivers(page?: string, limit?: string, status?: string, search?: string): Promise<{
        data: {
            isAvailable: boolean;
            user: {
                id: string;
