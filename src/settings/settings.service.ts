...
const DEFAULT_SETTINGS = [
  ...
  // PagSeguro Settings
  {
    key: 'pagseguro_enabled',
    value: 'false',
    type: 'BOOLEAN',
    category: 'payment',
    label: 'PagSeguro Habilitado',
    description: 'Habilita pagamentos via PagSeguro',
    isPublic: true,
  },
  {
    key: 'pagseguro_token',
    ...
    type: 'STRING',
    category: 'payment',
    label: 'PagSeguro Token',
    description: 'Token de autenticacao do PagSeguro',
    isPublic: false,
  },
  {
    key: 'pagseguro_email',
    ...
    description: 'Email da conta PagSeguro',
    isPublic: false,
  },
  {
    key: 'pagseguro_sandbox',
    value: 'true',
    type: 'BOOLEAN',
    category: 'payment',
    label: 'PagSeguro Sandbox',
    description: 'Usar ambiente de testes do PagSeguro',
    isPublic: false,
  },
  // PIX Settings
  {
  ...
  },
  {
    ...
    category: 'payment',
    label: 'Chave PIX',
    description: 'Chave PIX para recebimento (CPF, CNPJ, email, telefone ou aleatoria)',
    isPublic: false,
  },
  {
    key: 'pix_key_type',
  ...
  },
  {
    ...
    description: 'Nome que aparece no QR Code PIX (max 25 caracteres)',
    isPublic: true,
  },
  {
    ...
    description: 'Cidade que aparece no QR Code PIX (max 15 caracteres)',
    isPublic: true,
  },
  {
    ...
    description: 'Tempo de validade do QR Code PIX em minutos',
    isPublic: true,
  },
  {
    key: 'cash_enabled',
